...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>Dunord </title>
	...
	<body <?php echo implode(' ', array_map(function($prop, $value) {
		...
		?>
					...
					<div class="pull-right">
						...
						<?if(!isset($_SESSION[Perfil])){?>
							<div id="Login" class="btn-header transparent pull-right">
								<span> <a href="<?php echo APP_URL; ?>/login.php" title="Login"><i class="fa fa-sign-in"></i> Iniciar Sesion </a> </span>
							</div>
						<?}else{?>		
							<!-- logout button -->
							<div id="logout" class="btn-header transparent pull-right">
								<span> <a href="php/Usuario-Cerrar.php" title="Sign Out" data-action="userLogout" data-logout-msg="¿Estas seguro de que quieres cerrar sesion?"><i class="fa fa-sign-out"></i> Cerrar Sesion</a> </span>
							</div>
						<?}?>
						<!-- end logout button -->
						...
						<ul class="header-dropdown-list hidden-xs">
							<li>
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
									<img src="<?php echo ASSETS_URL; ?>/img/blank.gif" class="flag flag-es" alt="Spanish"> <span> Español (ES) </span> <i class="fa fa-angle-down"></i> </a>
								<ul class="dropdown-menu pull-right">
									<li class="active">
				...
				<!-- END SHORTCUT AREA -->
				<?if(isset($_SESSION[Perfil])){
					if($_SESSION[Perfil]=="A" or $_SESSION[Perfil]=="E"){?>
						<body class="smart-style-1">
					<?}?>
				<?}else{?>
					<body class="menu-on-top smart-style-1">
				<?}?>
		<?php
			}
		?>